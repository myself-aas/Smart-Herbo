...
import { loadBovineModel, predictWeight, validateCattlePresence } from './services/tfjsService';
  ...
  const handlePredict = async () => {
    ...
    try {
      ...
      if (!presenceValidation.isValid) {
        setStep('form');
        setErrors({ global: presenceValidation.reason || "Cattle validation failed." });
        return;
      }
